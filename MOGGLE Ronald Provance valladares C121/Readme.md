...
Lo primero que tendrás que hacer para poder trabajar en este proyecto es instalar .NET Core 7.0 (lo que a esta altura imaginamos que no sea un problema, ¿verdad?). Luego, solo te debes parar en la carpeta del proyecto y ejecutar en la terminal de Linux:
